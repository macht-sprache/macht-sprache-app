...
<CollapsableSection
    ...
    intro="New problems present themselves, those invested in making language less discriminatory must be willing to develop new strategies to tackle those problems">
...
<CollapsableSection title="Pragmatic [future-oriented, accessible, collaborative, creative]">
