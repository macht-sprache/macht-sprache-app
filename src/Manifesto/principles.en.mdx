...
The following three points summarise the understaning of translation that macht.sprache. advocates and recommends. For each fundamental principle, there is an explanation and example. You can join the discussion by clicking on the terms.
