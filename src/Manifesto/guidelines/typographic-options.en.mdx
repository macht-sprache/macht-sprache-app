...
Instead of using what has been established as ‘correct grammar’, translators and writers can actively change language. Since language is a human-made discriminatory system, systemic choices - and changes - have to be made as well. Linguist Lann Hornscheidt points out that different typographies don’t need to be mutually exclusive. Several options can exist alongside each other. And new options will always continue to develop. When it comes to typographic options, it's a good idea to trust the communities in question and to use their preferred choices/forms of self-designation.
