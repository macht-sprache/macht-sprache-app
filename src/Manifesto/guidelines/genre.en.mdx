...
Genre and register of a text are also strongly connected to the fundamental principle of positionalities [link]. Considering who the author’s and translator’s intended audiences are will help the translator choose the right register for the translation.

<TermExampleContainer>
    <TermExample term="microaggressions" />
</TermExampleContainer>
